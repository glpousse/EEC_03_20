...
use Data/Clean/SYNTH_2, clear 
	...
	* Controls 
	global i_controls sexe married child wsalred_lowess_2015 wsalred_lowess_2015_sq age age_sq ancentr cat_naf10
	global c_controls gs_gdp CBC 
	
	/* DICTIONNARY:
		
		- wsalred_lowess_2015 , hhplus_lowess
		- wsalred_CMA_2015 , hhplus_CMA
		- wsalred_LMA_2015 , hhplus_LMA
		- salred1_2015   , hplus1
		- wsalred_lowess 
		- wsalred_CMA 
		- wsalred_LMA 
	...
	* SIMPLE OLS MODELS (DiD) 
	...
	reghdfe hplus1 post_treatment treatment $i_controls $c_controls [pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num) 
	...
	* LOGISTIC MODELS
	xtset indiv_num datdeb
	xtlogit tplus post_treatment treatment $i_controls $c_controls i.datdeb_m, fe 	
