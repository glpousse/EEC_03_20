...
***** Trimming observations ***** 
	...
	* Active Population 
	...
	drop if (res == 16 | res == 14 | ret == 1) 	// ménage composé exclusivement d'inactifs de 65 ans et plus
...
/*	Before being able to keep the for-profit non-agricultural sector, I need to harmonize naf10: 
	...
	* Sampled workers: 
	...
	gen hours_70		= (hhc <= 70)								// working less than 70 hours 
...
save Data/Clean/df3_master_with_outliers, replace 
	
***** Removing OUTLIERS *****

use Data/Clean/df3_master_with_outliers, clear 
...
save Clean/df4_master_no_outliers.dta, replace 
...
use Clean/df4_master_no_outliers, clear
...
save Clean/df5_master_dummies.dta, replace 

********************************
***** Making the TEPA data ***** 
********************************

use Clean/df5_master_dummies, clear 
