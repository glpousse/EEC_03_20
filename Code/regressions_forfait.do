...
use Data/Clean/SYNTH_2, clear 
	...
	* TD DUMMIES - GENDER								// Not conclusive 
...
* OG
	...
	* DiD
	eststo m1_1: reghdfe emphre post_treatment treatment $i_controls $c_controls [pweight=extri], ///
	...
	eststo m1_3: reghdfe abs_wedge  optim post_treatment treatment $i_controls $c_controls [pweight=extri], ///
	absorb(datdeb indiv_num) 	vce(cluster indiv_num)
...
* A1  
	...
	* DiD
	eststo m2_1: reghdfe emphre post_treatment treatment $i_controls   $c_controls [pweight=extri], ///
	absorb( datdeb indiv_num) 	 vce(cluster indiv_num)
...
* LMA 
	...
	* DiD
	...
	reghdfe tplus_LMA post_treatment treatment $i_controls   if naf4 == "ET" [pweight=extri], ///
	absorb( datdeb indiv_num) 	 vce(cluster indiv_num)											// **				
...
* OG 
	...
	eststo td1_1: reghdfe hplus triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_lowess < 2000   ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td1_2: reghdfe empnbh triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_lowess < 2000   ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td1_3: reghdfe abs_wedge triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_lowess < 2000   ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td1_4: reghdfe wedge_sq triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_lowess < 2000  ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td1_5: reghdfe tplus triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_lowess < 2000   ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	esttab td1_1 td1_2 td1_3 td1_4 td1_5 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)
...
* A1
	...
	eststo td2_1: reghdfe hplus1 triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if salred1 > 2000 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td2_2: reghdfe empnbh triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if salred1 > 2000 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td2_3: reghdfe abs_wedge1 triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if salred1 > 2000 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td2_4: reghdfe wedge1_sq triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if salred1 > 2000 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td2_5: reghdfe tplus1 triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if salred1 > 2000 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	esttab td2_1 td2_2 td2_3 td2_4 td2_5 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)
...
* CMA	
	...
	eststo td3_1: reghdfe hplus_CMA triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_CMA < 1500 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td3_2: reghdfe empnbh triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_CMA < 1500 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td3_3: reghdfe abs_wedge_CMA triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_CMA < 1500 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td3_4: reghdfe wedge_CMA_sq triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_CMA < 1500 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)

	eststo td3_5: reghdfe tplus_CMA triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_CMA < 1500 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	esttab td3_1 td3_2 td3_3 td3_4 td3_5 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)
...
*LMA	
	...
	eststo td4_1: reghdfe hplus_LMA triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_LMA <2000 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)

	eststo td4_2: reghdfe empnbh triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_LMA <2000 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td4_3: reghdfe abs_wedge_LMA triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_LMA <2000 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td4_4: reghdfe wedge_LMA_sq triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_LMA <2000 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td4_5: reghdfe tplus_LMA triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls if wsalred_LMA <2000 ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	esttab td4_1 td4_2 td4_3 td4_4 td4_5 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)
...
* Lowess 	
	...
	eststo td5_1: eststo td4_5: reghdfe hplus_lowess triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls  ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td5_2: reghdfe empnbh triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls  ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td5_3: reghdfe abs_wedge_lowess triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td5_4: reghdfe wedge_lowess_sq triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls  ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	eststo td5_5: reghdfe tplus_lowess triple_optim optim post_treatment treatment_optim treatment $i_controls $c_controls  ///
	[pweight=extri], absorb(datdeb indiv_num) vce(cluster indiv_num)
	
	esttab td5_1 td5_2 td5_3 td5_4 td5_5 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)
...
* OG
	...
	* DiD
	...
	esttab m1_11 m1_21 m1_31 m1_41 m1_51 , keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 1st tertile of wage distrib
	esttab m1_12 m1_22 m1_32 m1_42 m1_52 , keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 2nd tertile of wage distrib
	esttab m1_13 m1_23 m1_33 m1_43 m1_53 , keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 3rd tertile of wage distrib
...
* A1  
	...
	* DiD
	...
	esttab m2_11 m2_21 m2_31 m2_41 m2_51 , keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 1st tertile of wage distrib
	esttab m2_12 m2_22 m2_32 m2_42 m2_52 , keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 2nd tertile of wage distrib
	esttab m2_13 m2_23 m2_33 m2_43 m2_53 , keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 3rd tertile of wage distrib
...
* CMA 
	...
	* DiD
	eststo m3_11: reghdfe hhplus_CMA post_treatment treatment $i_controls  $c_controls [pweight=extri] if tertile_CMA == 1, ///
	absorb( datdeb indiv_num) 	 vce(cluster indiv_num)
	eststo m3_12: reghdfe hhplus_CMA post_treatment treatment $i_controls  $c_controls [pweight=extri] if tertile_CMA == 2, ///
	absorb( datdeb indiv_num) 	 vce(cluster indiv_num)
	eststo m3_13: reghdfe hhplus_CMA post_treatment treatment $i_controls  $c_controls [pweight=extri] if tertile_CMA == 3, ///
	absorb( datdeb indiv_num) 	 vce(cluster indiv_num)
	...
	esttab m3_11 m3_21 m3_31 m3_41 m3_51, keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 1st tertile of wage distrib
	esttab m3_12 m3_22 m3_32 m3_42 m3_52, keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 2nd tertile of wage distrib
	esttab m3_13 m3_23 m3_33 m3_43 m3_53, keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 3rd tertile of wage distrib
...
* LMA 
	...
	* DiD
	eststo m4_11: reghdfe hhplus_LMA post_treatment treatment $i_controls $c_controls [pweight=extri] if tertile_LMA ==1, ///
	absorb(datdeb indiv_num) vce(cluster indiv_num)
	eststo m4_12: reghdfe hhplus_LMA post_treatment treatment $i_controls $c_controls [pweight=extri] if tertile_LMA ==2, ///
	absorb(datdeb indiv_num) vce(cluster indiv_num)
	eststo m4_13: reghdfe hhplus_LMA post_treatment treatment $i_controls $c_controls  [pweight=extri] if tertile_LMA ==3, ///
	absorb(datdeb indiv_num) vce(cluster indiv_num)
	...
	esttab m4_11 m4_21 m4_31 m4_41 m4_51, keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 1st tertile of wage distrib
	esttab m4_12 m4_22 m4_32 m4_42 m4_52, keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 2nd tertile of wage distrib
	esttab m4_13 m4_23 m4_33 m4_43 m4_53, keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 3rd tertile of wage distrib
...
* Lowess
	...
	* DiD
	eststo m5_11: reghdfe hhplus_lowess post_treatment treatment $i_controls  $c_controls [pweight=extri] if tertile_lowess == 1, ///
	absorb( datdeb indiv_num) 	 vce(cluster indiv_num)
	eststo m5_12: reghdfe hhplus_lowess post_treatment treatment $i_controls  $c_controls [pweight=extri] if tertile_lowess == 2, ///
	absorb( datdeb indiv_num) 	 vce(cluster indiv_num)
	eststo m5_13: reghdfe hhplus_lowess post_treatment treatment $i_controls  $c_controls [pweight=extri] if tertile_lowess == 3, ///
	absorb( datdeb indiv_num) 	 vce(cluster indiv_num)
	...
	esttab m5_11 m5_21 m5_31 m5_41 m5_51, keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 1st tertile of wage distrib
	esttab m5_12 m5_22 m5_32 m5_42 m5_52, keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 2nd tertile of wage distrib
	esttab m5_13 m5_23 m5_33 m5_43 m5_53, keep(post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 3rd tertile of wage distrib
...
*** TD *** 
	...
	* OG 
	...
	esttab td1_11 td1_21 td1_31 td1_41 td1_51 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)	// 1st tertile of wage distrib 
	esttab td1_12 td1_22 td1_32 td1_42 td1_52 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)	// 2nd tertile of wage distrib
	esttab td1_13 td1_23 td1_33 td1_43 td1_53 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)	// 3rd tertile of wage distrib 
...
* A1
	...
	esttab td2_11 td2_21 td2_31 td2_41 td2_51 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)	// 1st tertile of wage distrib 
	esttab td2_12 td2_22 td2_32 td2_42 td2_52 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)	// 2nd tertile of wage distrib
	esttab td2_13 td2_23 td2_33 td2_43 td2_53 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)	// 3rd tertile of wage distrib 
...
* CMA	
	...
	esttab td3_11 td3_21 td3_31 td3_41 td3_51 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 1st tertile of wage distrib	
	esttab td3_12 td3_22 td3_32 td3_42 td3_52 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 2nd tertile of wage distrib 
	esttab td3_13 td3_23 td3_33 td3_43 td3_53 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 3rd tertile of wage distrib 
...
*LMA	
	...
	esttab td4_11 td4_21 td4_31 td4_41 td4_51 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 1st tertile of wage distrib
	esttab td4_12 td4_22 td4_32 td4_42 td4_52 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 2nd tertile of wage distrib
	esttab td4_13 td4_23 td4_33 td4_43 td4_53 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 3rd tertile of wage distrib
...
* Lowess 	
	...
	esttab td5_11 td5_21 td5_31 td5_41 td5_51 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 1st tertile of wage distrib 
	esttab td5_12 td5_22 td5_32 td5_42 td5_52 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 2nd tertile of wage distrib 
	esttab td5_13 td5_23 td5_33 td5_43 td5_53 , keep(triple_optim post_treatment) p star(* 0.10 ** 0.05 *** 0.01)		// 3rd tertile of wage distrib 
